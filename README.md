...
- ros-mcp-server has been updated significantly for easier integration with any type of robot not just quadruped
...
**Note:** If using spot you will see spot_0 instead of unitree_go2_0:
